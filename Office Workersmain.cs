...
namespace Hospital
{
    public partial class Office_Workersmain : Form
    {
        ...
        private void display_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from office", connect);
        ...
        private void serach_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM office WHERE id = @employeeID", connect))
                {
        ...
        {
            Attendantsmain mForm = new Hospital.Attendantsmain();
            mForm.Show();
            this.Hide();
        }
