...
namespace Hospital
{
    public partial class Microbiology_attendants : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from attendant WHERE department = 'Microbiology';", connect);
