...
namespace Hospital
{
    public partial class General_Surgery_patient : Form
    {
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from patient WHERE department = 'General Surgery';", connect);
