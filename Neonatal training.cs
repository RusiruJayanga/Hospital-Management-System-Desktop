...
namespace Hospital
{
    public partial class Neonatal_training : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Neonatal';", connect);
        ...
        {
            Neonatal_nurses mForm = new Neonatal_nurses();
            mForm.Show();
            this.Hide();
        }
