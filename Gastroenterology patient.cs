...
namespace Hospital
{
    public partial class Gastroenterology_patient : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from patient WHERE department = 'Gastroenterology';", connect);
