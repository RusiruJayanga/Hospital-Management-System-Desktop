...
namespace Hospital
{
    public partial class General_Surgery_clinics : Form
    {
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "DELETE FROM surgery WHERE id = @employeeID;";
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE surgery SET  hall = @fullName" +
                            ", pid = @gender, did = @contactNum" +
                            ", department = 'General Surgery', nid = @position, date = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from surgery WHERE department = 'General Surgery';", connect);
