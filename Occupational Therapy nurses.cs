...
namespace Hospital
{
    public partial class Occupational_Therapy_nurses : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Occupational Therapy';", connect);
