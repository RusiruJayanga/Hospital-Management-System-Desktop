...
namespace Hospital
{
    public partial class Burn_Center_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Burn Center', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Burn Center', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Burn Center';", connect);
        ...
        {
            Burn_Center_training mForm = new Burn_Center_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Burn_Center_patient mForm = new Burn_Center_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Burn_Center_clinics mForm = new Burn_Center_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Burn_Center_office mForm = new Burn_Center_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Burn_Center_attendants mForm = new Burn_Center_attendants();
            mForm.Show();
            this.Hide();
        }
