...
namespace Hospital
{
    public partial class Neonatal_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Neonatal', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Neonatal', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Neonatal';", connect);
        ...
        {
            Neonatal_training mForm = new Neonatal_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Neonatal_patient mForm = new Neonatal_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Neonatal_clinics mForm = new Neonatal_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Neonatal_office mForm = new Neonatal_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Neonatal_attendants mForm = new Neonatal_attendants();
            mForm.Show();
            this.Hide();
        }
