...
namespace Hospital
{
    public partial class Accident_and_emergency_doctors : Form

    {
        ...
        public Accident_and_emergency_doctors()
        {
            InitializeComponent();
        }
        ...
        private void Accident_and_emergency_doctors_Load(object sender, EventArgs e)
        {
        ...
        private void Nursesnav_Click_1(object sender, EventArgs e)
        {
            Accident_and_emergency_nurses mForm = new Accident_and_emergency_nurses();
            mForm.Show();
            this.Hide();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Accident and emergency', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE doctor SET name = @fullName" +
                            ...
                            ", department = 'Accident and emergency', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from doctor WHERE department = 'Accident and emergency';", connect);
        ...
        {
            Accident_and_emergency_training mForm = new Accident_and_emergency_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Accident_and_emergency_patient mForm = new Accident_and_emergency_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Accident_and_emergency_clinics mForm = new Accident_and_emergency_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Accident_and_emergency_office mForm = new Accident_and_emergency_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Accident_and_emergency_attendants mForm = new Accident_and_emergency_attendants();
            mForm.Show();
            this.Hide();
        }

        private void Doctorsmain_Click_1(object sender, EventArgs e)
        {
        ...
        private void Nursesmain_Click_1(object sender, EventArgs e)
        {
        ...
        private void Trainingmain_Click_1(object sender, EventArgs e)
        {
        ...
        private void Patientsmain_Click_1(object sender, EventArgs e)
        {
        ...
        private void Clinicsmain_Click_1(object sender, EventArgs e)
        {
        ...
        private void Office_Workersmain_Click_1(object sender, EventArgs e)
        {
        ...
        private void Attendantsmain_Click_1(object sender, EventArgs e)
        {
