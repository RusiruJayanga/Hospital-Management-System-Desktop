...
namespace Hospital
{
    ...
    public partial class General_Surgery_training : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'General Surgery';", connect);
        ...
        {
            General_Surgery_nurses mForm = new General_Surgery_nurses();
            mForm.Show();
            this.Hide();
        }
