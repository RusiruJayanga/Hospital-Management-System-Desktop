...
namespace Hospital
{
    public partial class General_Surgery_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'General Surgery', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'General Surgery', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'General Surgery';", connect);
        ...
        {
            General_Surgery_training mForm = new General_Surgery_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            General_Surgery_patient mForm = new General_Surgery_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            General_Surgery_clinics mForm = new General_Surgery_clinics();
            mForm.Show();
            this.Hide();
        }
    }
