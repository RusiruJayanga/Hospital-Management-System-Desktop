...
namespace Hospital
{
    public partial class Microbiology_nurses : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Microbiology';", connect);
        ...
        {
            Microbiology_patient mForm = new Microbiology_patient();
            mForm.Show();
            this.Hide();
        }
