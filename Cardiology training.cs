...
namespace Hospital
{
    public partial class Cardiology_training : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Cardiology';", connect);
        ...
        {
            Cardiology_nurses mForm = new Cardiology_nurses();
            mForm.Show();
            this.Hide();
        }
