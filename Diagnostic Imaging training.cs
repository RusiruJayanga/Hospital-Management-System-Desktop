...
namespace Hospital
{
    public partial class Diagnostic_Imaging_training : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Diagnostic Imaging';", connect);
        ...
        {
            Diagnostic_Imaging_nurses mForm = new Diagnostic_Imaging_nurses();
            mForm.Show();
            this.Hide();
        }
