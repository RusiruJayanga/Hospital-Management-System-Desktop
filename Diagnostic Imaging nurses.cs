...
namespace Hospital
{
    public partial class Diagnostic_Imaging_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Diagnostic Imaging', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Diagnostic Imaging', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Diagnostic Imaging';", connect);
        ...
        {
            Diagnostic_Imaging_training mForm = new Diagnostic_Imaging_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Diagnostic_Imaging_patient mForm = new Diagnostic_Imaging_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Diagnostic_Imaging_clinics mForm = new Diagnostic_Imaging_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Diagnostic_Imaging_office mForm = new Diagnostic_Imaging_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Diagnostic_Imaging_attendants mForm = new Diagnostic_Imaging_attendants();
            mForm.Show();
            this.Hide();
        }
