...
namespace Hospital
{
    public partial class Accident_and_emergency_office : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    {
                        connect.Open();
                        string checkEmID = "SELECT COUNT(*) FROM office WHERE id = @employeeID";
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string insertData = "SET IDENTITY_INSERT office ON; " +
                    "INSERT INTO office " +
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "DELETE FROM office WHERE id = @employeeID;";
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE office SET name = @fullName" +
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from office WHERE department = 'Accident and emergency';", connect);
