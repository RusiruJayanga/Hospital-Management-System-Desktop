...
namespace Hospital
{
    public partial class Gastroenterology_nurses : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Gastroenterology';", connect);
        ...
        {
            Gastroenterology_attendants mForm = new Gastroenterology_attendants();
            mForm.Show();
            this.Hide();
        }
