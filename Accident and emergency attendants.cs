...
namespace Hospital
{
    public partial class Accident_and_emergency_attendants : Form
    {
        SqlConnection connect
         = new SqlConnection(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=True");

        public Accident_and_emergency_attendants()
        {
            InitializeComponent();
        }
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from attendant WHERE department = 'Accident and emergency';", connect);
