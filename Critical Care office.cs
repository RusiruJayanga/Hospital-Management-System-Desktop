...
namespace Hospital
{
    public partial class Critical_Care_office : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from office WHERE department = 'Critical Care';", connect);
