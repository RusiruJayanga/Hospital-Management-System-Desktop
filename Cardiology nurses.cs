...
namespace Hospital
{
    public partial class Cardiology_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Cardiology', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Cardiology', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Cardiology';", connect);
        ...
        {
            Cardiology_training mForm = new Cardiology_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Cardiology_patient mForm = new Cardiology_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Cardiology_clinics mForm = new Cardiology_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Cardiology_office mForm = new Cardiology_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Cardiology_attendants mForm = new Cardiology_attendants();
            mForm.Show();
            this.Hide();
        }
