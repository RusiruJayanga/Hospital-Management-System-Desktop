...
namespace Hospital
{
    public partial class Radiology_doctors : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from doctor WHERE department = 'Radiology';", connect);
