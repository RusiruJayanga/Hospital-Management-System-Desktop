...
namespace Hospital
{
    public partial class Endoscopy_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Endoscopy', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Endoscopy', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Endoscopy';", connect);
        ...
        {
            Endoscopy_training mForm = new Endoscopy_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Endoscopy_patient mForm = new Endoscopy_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Endoscopy__clinics mForm = new Endoscopy__clinics();
            mForm.Show();
            this.Hide();
        }
    }
