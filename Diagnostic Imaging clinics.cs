...
namespace Hospital
{
    public partial class Diagnostic_Imaging_clinics : Form
    {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE clinic SET  hall = @fullName" +
                            ...
                            ", department = 'Diagnostic Imaging', nid = @position, date = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from clinic WHERE department = 'Diagnostic Imaging';", connect);
