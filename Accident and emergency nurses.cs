...
namespace Hospital
{
    public partial class Accident_and_emergency_nurses : Form
    {
        ...
        private void Accident_and_emergency_nurses_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    {
                        connect.Open();
                        string checkEmID = "SELECT COUNT(*) FROM nurse WHERE id = @employeeID";
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string insertData = "SET IDENTITY_INSERT nurse ON; " +
                    "INSERT INTO nurse " +
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "DELETE FROM nurse WHERE id = @employeeID;";
            ...
            else
            {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Accident and emergency';", connect);
        ...
        private void Doctornav_Click_1(object sender, EventArgs e)
        {
            Accident_and_emergency_doctors mForm = new Accident_and_emergency_doctors();
            mForm.Show();
            this.Hide();
