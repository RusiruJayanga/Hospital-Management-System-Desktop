    ...
    public partial class Radiology_training : Form
    {
       ...
       = new SqlConnection(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=True");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Radiology';", connect);
        ...
        {
            Radiology_nurses mForm = new Radiology_nurses();
            mForm.Show();
            this.Hide();
        }
