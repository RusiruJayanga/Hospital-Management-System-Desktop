...
namespace Hospital
{
    public partial class Critical_Care_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Critical Care', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Critical Care', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Critical Care';", connect);
        ...
        {
            Critical_Care_training mForm = new Critical_Care_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Critical_Care_patient mForm = new Critical_Care_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Critical_Care_clinics mForm = new Critical_Care_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Critical_Care_office mForm = new Critical_Care_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Critical_Care_attendants mForm = new Critical_Care_attendants();
            mForm.Show();
            this.Hide();
        }
