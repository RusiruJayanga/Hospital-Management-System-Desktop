...
namespace Hospital
{
    public partial class Radiotherapy_nurses : Form
    {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Radiotherapy', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Radiotherapy';", connect);
        ...
        {
            Radiotherapy_clinics mForm = new Radiotherapy_clinics();
            mForm.Show();
            this.Hide();
        }
