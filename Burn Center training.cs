    ...
    public partial class Burn_Center_training : Form
    {
       ...
       = new SqlConnection(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=True");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Burn Center';", connect);
        ...
        {
            Burn_Center_nurses mForm = new Burn_Center_nurses();
            mForm.Show();
            this.Hide();
        }
