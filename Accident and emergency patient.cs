...
namespace Hospital
{
    public partial class Accident_and_emergency_patient : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from patient WHERE department = 'Accident and emergency';", connect);
