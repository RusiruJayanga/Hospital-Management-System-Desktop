    ...
    public partial class Critical_Care_training : Form
    {
       ...
       = new SqlConnection(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=True");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Critical Care';", connect);
        ...
        {
            Critical_Care_nurses mForm = new Critical_Care_nurses();
            mForm.Show();
            this.Hide();
        }
