...
namespace Hospital
{
    public partial class Burn_Center_doctors : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from doctor WHERE department = 'Burn Center';", connect);
