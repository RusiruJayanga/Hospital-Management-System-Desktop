...
namespace Hospital
{
    public partial class Radiology_nurses : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State == ConnectionState.Closed)
                {
                    ...
                    "VALUES (@employeeID, @fullName, @contactNum, 'Radiology', @position, @status, @gender); " +
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE nurse SET name = @fullName" +
                            ...
                            ", department = 'Radiology', address = @position, dob = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from nurse WHERE department = 'Radiology';", connect);
        ...
        {
            Radiology_training mForm = new Radiology_training();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Radiology_patient mForm = new Radiology_patient();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Radiology_clinics mForm = new Radiology_clinics();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Radiology_office mForm = new Radiology_office();
            mForm.Show();
            this.Hide();
        }
        ...
        {
            Radiology_attendants mForm = new Radiology_attendants();
            mForm.Show();
            this.Hide();
        }
