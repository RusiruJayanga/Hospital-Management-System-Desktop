...
namespace Hospital
{
    public partial class Occupational_Therapy_clinics : Form
    {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE clinic SET  hall = @fullName" +
                            ...
                            ", department = 'Occupational Therapy', nid = @position, date = @status " +
                            "WHERE id = @employeeID";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from clinic WHERE department = 'Occupational Therapy';", connect);
