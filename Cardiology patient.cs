...
namespace Hospital
{
    public partial class Cardiology_patient : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from patient WHERE department = 'Cardiology';", connect);
