...
namespace Hospital
{
    public partial class Radiotherapy_training : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Radiotherapy';", connect);
