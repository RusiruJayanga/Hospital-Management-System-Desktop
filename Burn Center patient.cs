    ...
    public partial class Burn_Center_patient : Form
    {
      ...
      = new SqlConnection(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=True");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from patient WHERE department = 'Burn Center';", connect);
