...
namespace Hospital
{
    public partial class clinicmain : Form
    {
                ...
                if (check == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string updateData = "UPDATE clinic SET  hall = @fullName" +
                            ...
                            ", department = @department, nid = @position, date = @status " +
                            "WHERE id = @employeeID";
        ...
        private void display_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from clinic", connect);
        ...
        private void serach_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM clinic WHERE id = @employeeID", connect))
                {
