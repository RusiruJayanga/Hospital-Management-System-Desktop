...
namespace Hospital
{
    public partial class Gastroenterology_training : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Gastroenterology';", connect);
