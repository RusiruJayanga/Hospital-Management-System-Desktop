    ...
    public partial class Endoscopy_training : Form
    {
      ...
      = new SqlConnection(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=hospital;Integrated Security=True");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                connect.Open();
                SqlCommand cmd = new SqlCommand("select * from training WHERE department = 'Endoscopy';", connect);
        ...
        {
            Endoscopy_nurses mForm = new Endoscopy_nurses();
            mForm.Show();
            this.Hide();
        }
